...
public class AuthService
        extends AbstractService<AuthUserMapper, AuthUserRepository>
        implements UserDetailsService, BaseService {

    private final ServerProperties serverProperties;
    private final ObjectMapper objectMapper;

    public AuthService( @Qualifier( "authUserMapperImpl" ) AuthUserMapper mapper, AuthUserRepository repository, ServerProperties serverProperties, ObjectMapper objectMapper) {
